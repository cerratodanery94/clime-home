...
$correo= $_POST["correo"];
	...
	try{
       ...
       if ($num_rows>0){ 
		   echo '<script>alert("Usuario o Correo ya esta registrado");window.location.href= "../vistas/autoregistro_vista.php"</script>';
	   ...
	   if ($resultado) {
		echo '<script>alert("Se ha registrado exitosamente,revise su correo electronico");window.location.href= "../vistas/login_vista.php"</script>';
			
	   } else {
		echo '<script>alert("Error al registrarse");window.location.href= "../vistas/autoregistro_vista.php"</script>';	
		}
