...
function validar_recu(){
    ...
    function Validar_actualizar_mant(){
        ...
        //validar campo usuario
        if (Formulario_actualizar_mant.usu.value==""){
        ...
        Formulario_actualizar_mant.usu.focus();
        Formulario_actualizar_mant.usu.value="";
        return false; 
          }
        else if (validar_longitud(Formulario_actualizar_mant.usu.value)==false){
       ...
       else if (Validar_espacio(Formulario_actualizar_mant.usu.value)==false){  
       ...
       return false;
       ...
       else if (validar_texto (Formulario_actualizar_mant.usu.value)==false){
       ...
       else if (Validar_espacio2(Formulario_actualizar_mant.usu.value)==false){  
        ...
        if (Formulario_actualizar_mant.usu_nombre.value=="") {
          //alert('Campos vacios');
          ...
          Formulario_actualizar_mant.usu_nombre.focus();
          Formulario_actualizar_mant.usu_nombre.value="";
          return false;
      }
      else if (validar_texto (Formulario_actualizar_mant.usu_nombre.value)==false){
          ...
          else if (validar_tamaño (Formulario_actualizar_mant.usu_nombre.value)==false){
          ...
          return false;
              ...
              else if (Validar_espacio2 (Formulario_actualizar_mant.usu_nombre.value)==false){
                  document.getElementById("alerta_mant").innerHTML='<div class="alert alert-danger"><a href="" class="close" data-dismiss="alert">&times;</a>LIMITE DE ESPACIOS EN EL CAMPO</div>';
                  Formulario_actualizar_mant.usu_nombre.focus();
                  Formulario_actualizar_mant.usu_nombre.value=""
                  return false;
                  }
                  else if (Validar_espacio (Formulario_actualizar_mant.usu_nombre.value)==false){
                      document.getElementById("alerta_mant").innerHTML='<div class="alert alert-danger"><a href="" class="close" data-dismiss="alert">&times;</a>LIMITE DE ESPACIOS EN EL CAMPO</div>';
                      Formulario_actualizar_mant.usu_nombre.focus();
                      Formulario_actualizar_mant.usu_nombre.value=""
                      return false;
              ...
              //Validar campo apellido:
              if (Formulario_actualizar_mant.usu_apellido.value=="") {
                  //alert('Campos vacios');
                  ...
                  Formulario_actualizar_mant.usu_apellido.focus();
                  Formulario_actualizar_mant.usu_apellido.value="";
                  return false;
              }
              else if (validar_texto (Formulario_actualizar_mant.usu_apellido.value)==false){
                  ...
                  else if (validar_tamaño (Formulario_actualizar_mant.usu_apellido.value)==false){
                      document.getElementById("alerta_mant").innerHTML='<div class="alert alert-danger"><a href="" class="close" data-dismiss="alert">&times;</a>LIMITE DE CARACTERES EN EL CAMPO</div>';
                      Formulario_actualizar_mant.usu_apellido.focus();
                      Formulario_actualizar_mant.usu_apellido.value="";
                  return false;
                      }
                      else if (Validar_espacio2 (Formulario_actualizar_mant.usu_apellido.value)==false){
                          document.getElementById("alerta_mant").innerHTML='<div class="alert alert-danger"><a href="" class="close" data-dismiss="alert">&times;</a>LIMITE DE ESPACIOS EN EL CAMPO</div>';
                          Formulario_actualizar_mant.usu_apellido.focus();
                          Formulario_actualizar_mant.usu_apellido.value="";
                          return false;
                          }
                          else if (Validar_espacio (Formulario_actualizar_mant.usu_apellido.value)==false){
                              document.getElementById("alerta_mant").innerHTML='<div class="alert alert-danger"><a href="" class="close" data-dismiss="alert">&times;</a>LIMITE DE ESPACIOS EN EL CAMPO</div>';
                              Formulario_actualizar_mant.usu_apellido.focus();
                              Formulario_actualizar_mant.usu_apellido.value="";
                              return false;
          ...
          if (Formulario_actualizar_mant.usu_estado.value=="") {
              //alert('Campos vacios');
              document.getElementById("alerta_mant").innerHTML='<div class="alert alert-danger"><a href="" class="close" data-dismiss="alert">&times;</a>CAMPO ESTADO VACIO</div>';
              Formulario_actualizar_mant.usu_estado.focus();
              Formulario_actualizar_mant.usu_estado.value="";
              return false;
          }
          else if (validar_texto (Formulario_actualizar_mant.usu_estado.value)==false){
              document.getElementById("alerta_mant").innerHTML='<div class="alert alert-danger"><a href="" class="close" data-dismiss="alert">&times;</a>CAMPO ESTADO NO PUEDE CONTENER NUMEROS</div>';
              Formulario_actualizar_mant.usu_estado.focus();
              Formulario_actualizar_mant.usu_estado.value="";
              return false;
              }
              else if (validar_tamaño (Formulario_actualizar_mant.usu_estado.value)==false){
                  document.getElementById("alerta_mant").innerHTML='<div class="alert alert-danger"><a href="" class="close" data-dismiss="alert">&times;</a>LIMITE DE CARACTERES EN EL CAMPO</div>';
                  Formulario_actualizar_mant.usu_estado.focus();
                  Formulario_actualizar_mant.usu_estado.value="";
              return false;
                  }
                  else if (Validar_espacio2 (Formulario_actualizar_mant.usu_estado.value)==false){
                      document.getElementById("alerta_mant").innerHTML='<div class="alert alert-danger"><a href="" class="close" data-dismiss="alert">&times;</a>LIMITE DE ESPACIOS EN EL CAMPO</div>';
                      Formulario_actualizar_mant.usu_estado.focus();
                      Formulario_actualizar_mant.usu_estado.value="";
                      return false;
                      }
                      else if (Validar_espacio (Formulario_actualizar_mant.usu_estado.value)==false){
                          document.getElementById("alerta_mant").innerHTML='<div class="alert alert-danger"><a href="" class="close" data-dismiss="alert">&times;</a>LIMITE DE ESPACIOS EN EL CAMPO</div>';
                          Formulario_actualizar_mant.usu_estado.focus();
                          Formulario_actualizar_mant.usu_estado.value="";
                          return false;
          ...
          //Validar Rol:
          if (Formulario_actualizar_mant.usu_rol.value=="") {
              //alert('Campos vacios');
              document.getElementById("alerta_mant").innerHTML='<div class="alert alert-danger"><a href="" class="close" data-dismiss="alert">&times;</a>CAMPO ROL VACIO</div>';
              Formulario_actualizar_mant.usu_rol.focus();
              Formulario_actualizar_mant.usu_rol.value="";
              return false;
              }
              else if (Validar_espacio2 (Formulario_actualizar_mant.usu_rol.value)==false){
                  document.getElementById("alerta_mant").innerHTML='<div class="alert alert-danger"><a href="" class="close" data-dismiss="alert">&times;</a>LIMITE DE ESPACIOS EN EL CAMPO</div>';
                  Formulario_actualizar_mant.usu_rol.focus();
                  Formulario_actualizar_mant.usu_rol.value="";
                  return false;
                  }
                  else if (Validar_espacio (Formulario_actualizar_mant.usu_rol.value)==false){
                      document.getElementById("alerta_mant").innerHTML='<div class="alert alert-danger"><a href="" class="close" data-dismiss="alert">&times;</a>LIMITE DE ESPACIOS EN EL CAMPO</div>';
                      Formulario_actualizar_mant.usu_rol.focus();
                      Formulario_actualizar_mant.usu_rol.value="";
                      return false;
                      }
                      /*else if (Validar_numero (Formulario_actualizar_mant.usu_rol.value)==false){
                          document.getElementById("alerta_mant").innerHTML='<div class="alert alert-danger"><a href="" class="close" data-dismiss="alert">&times;</a>CAMPO NO PERMITE CARACTERES/div>';
                          Formulario_actualizar_mant.usu_rol.focus();
                          Formulario_actualizar_mant.usu_rol.value="";
                          return false;
                          }*/
                  //Validar campo correo:
                  if (Formulario_actualizar_mant.correo_usu.value=="") {
                      //alert('Campos vacios');
                      ...
                      Formulario_actualizar_mant.correo_usu.value=="";
                      Formulario_actualizar_mant.correo_usu.focus();

                      return false;  
                  }
                  else if (validar_tamaño (Formulario_actualizar_mant.correo_usu.value)==false){
                      ...
                      return false; 
                       ...
                       else if (Validar_correo(Formulario_actualizar_mant.correo_usu.value)== false){
